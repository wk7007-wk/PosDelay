...
- **0 안정화**: 양수→0 전환 시 90초 대기 (KDS 하트비트 3회분, systemui 오탐 방지)
...
- **교훈 — 교차검증으로 0 강제 금지**: 접근성 서비스의 rootInActiveWindow는 대상 앱 윈도우를 항상 반환하지 않음. "count>0인데 orders 비어있으니 0" 같은 교차검증은 정확한 탭 건수를 덮어쓰는 역효과 발생
